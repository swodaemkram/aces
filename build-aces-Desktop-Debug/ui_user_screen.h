...
public:
    ...
    void setupUi(QDialog *user_screen)
    {
        ...
        QPalette palette13;
        QBrush brush8(QColor(46, 52, 54, 255));
        ...
        QPalette palette19;
        QBrush brush10(QColor(186, 189, 182, 255));
        brush10.setStyle(Qt::SolidPattern);
        palette19.setBrush(QPalette::Active, QPalette::WindowText, brush10);
        QBrush brush11(QColor(203, 199, 196, 255));
        ...
        QBrush brush12(QColor(118, 116, 114, 255));
        ...
        gridLayoutWidget->setGeometry(QRect(10, 10, 838, 321));
        ...
        QBrush brush13(QColor(164, 0, 0, 255));
